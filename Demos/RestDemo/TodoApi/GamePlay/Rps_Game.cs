...
namespace TodoApi.GamePlay
{
	public class Rps_Game
	{
		...
		public Player GameAddPlayer(Player player)
		{
			...
			//Player tempPlayer;
			//_cache.TryGetValue("loggedInPlayer", out tempPlayer);

			//if (tempPlayer == null)
			//{
			//	tempPlayer = new Player()
			//	{
			//		Name = "_cache didnt work",
			//		PlayerId = 12000
			//	};
			//	return tempPlayer;
			//}
		...
		public Player TestCache()
		{
			Player p1;
			_cache.TryGetValue("loggedInPlayer", out p1);
		...
		public bool GameDeletePlayer(int id)
		{
			...
			Player lgp;
			_cache.TryGetValue("loggedInPlayer", out lgp);
			...
			if(lgp != null)
			{
				...
				_logger.LogError("\n\nThe cache was null in Rps_Game.GameDeletePlayer()!!!!!!!\n");
				return true;
			}
			return true;
		}
