...
using RpsDataAccess.DbAcces;
//using RpsDataAccess.GamePlay;

namespace RpsDataAccess.GamePlay
{
	public class Rps_Game
	{
		...
		public Rps_Game(ILogger<Rps_Game> logger, IMemoryCache cache, DatabaseAccess context)
		{
			_logger = logger;
			_cache = cache;
			_context = context;
